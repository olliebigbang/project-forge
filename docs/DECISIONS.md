...
| D-036 | **CONFIRMED** M1B1 provider spend has a USD 5 lifetime application hard cap enforced by Worker + D1. Each request reserves 201,280 micro-USD before invocation; verified usage settles, proven non-billed failures release, ambiguous billing commits the full reservation, and any guard uncertainty fails closed | Product-owner approved limit plus independent Safety/Red Team recommendation |
