...
| V-010 | **CONFIRMED in Chromium/WebKit; TO VALIDATE on physical iPhone** The reopened P0 candidate keeps the Canvas visible during synthetic keyboard geometry, restores it after Done/toolbars/rotation, keeps bow held through 10 arrows, lands a centred grenade on an explicit floor before its separate blast, emits no sword projectile, and returns the same boomerang instance | Separate keyboard and visual-role evidence reports plus retained v20 reports/screenshots |
