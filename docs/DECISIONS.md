...
| V-011 | **TO VALIDATE** The prototype reach curve uses 72-228 px effective reach, tier boundaries at 104/160/202 px, normalized-span anchors at 0.18/0.92, a 104 px held cross-axis cap, and a budget-neutral 450 px range-per-1.0-speed exchange. Current grip/direction is deterministic left-to-right | Automated monotonicity, fit, hit-distance, timing, resize and browser regression now; physical iPhone combat feel before acceptance |
